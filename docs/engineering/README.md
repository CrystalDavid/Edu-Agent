...
| Migration | `<module>/infrastructure/migrations/` + `apps/api/src/database/migrations.ts` | 序号、owner、43 个 Verified 基线文件不变；当前另含 Phase 7A、日历分类、Phase 8A-6 行动候选、Conversation/WorkingMemory、教师记忆应用观测、scoped Preference 与 Work command Turn 前向文件，共 51 个 |
