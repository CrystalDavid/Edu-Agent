...
| 主要文档 | [第一轮工程验证计划](history/research/教育智能体平台第一轮工程验证计划.md)、[Migration ownership](../infra/postgres/migration-ownership.md)。 |
...
| 主要文档 | [早期 0→1 调查](history/research/project-evolution-0-to-1.md)（SUPERSEDED，但保留调查证据）。 |
...
| 主要文档 | [Gate 2 UI redesign](history/ui/gate-2-ui-redesign.md)（SUPERSEDED）。 |
...
| 主要文档 | [UI redesign v2](history/ui/gate-2-ui-redesign-v2.md)（SUPERSEDED）。 |
...
| 主要文档 | [Teacher Portal UI v1](history/ui/teacher-portal-ui-v1.md)（HISTORICAL）。 |
...
| 主要文档 | [Gate 2.4](history/gates/gate-2-4-copilot-correctness.md)。 |
...
| 主要文档 | [Gate 2.5](history/gates/gate-2-5-recoverable-lesson-preparation.md)。 |
...
| 主要文档 | [Gate 2.6A](history/gates/gate-2-6a-volcengine-ark-provider.md)、[Live Acceptance](history/gates/gate-2-6a-live-acceptance.md)。 |
...
| 主要文档 | [Gate 2.5B](history/gates/gate-2-5b-file-and-teaching-artifacts.md)。 |
...
| 主要文档 | [Stabilization Matrix](history/gates/teacher-product-stabilization-matrix.md)。 |
...
| 主要文档 | [Gate 2.7](history/gates/gate-2-7-assignment-learning-evidence.md)。 |
...
| 主要文档 | [Gate 2.8](history/gates/gate-2-8-teacher-workbench.md)。 |
...
| 主要文档 | [Gate 2.9](history/gates/gate-2-9-classroom-reflection-loop.md)。 |
...
| 后续建议 | Gate 2.10B 应只解决云部署与试点运维差距，见 [部署准备差距](operations/deployment-readiness-gaps.md)。 |
| 主要文档 | [Gate 2.10A](history/gates/gate-2-10a-identity-organization-foundation.md)。 |
