...
| 云 ObjectStore | 当前正式 Adapter 是本地 `.demo/uploads/objects` | 实现同一 ObjectStore Port 的云 Adapter；私有 bucket、tenant-scoped key、加密、授权下载、大小/MIME/hash、补偿和 orphan cleanup；迁移/回滚方案 |
