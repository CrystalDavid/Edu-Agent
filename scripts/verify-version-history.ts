...
const stages: readonly VerifiedStage[] = [
  ...
  },
  {
    ...
    document: "docs/history/gates/GATE_2_4_COPILOT_CORRECTNESS.md"
  },
  {
    name: "Gate 2.5",
    ...
    document: "docs/history/gates/GATE_2_5_RECOVERABLE_LESSON_PREPARATION.md"
  },
  {
    name: "Gate 2.6A",
    ...
    document: "docs/history/gates/GATE_2_6A_VOLCENGINE_ARK_PROVIDER.md"
  },
  {
    name: "Gate 2.5B",
    ...
    document: "docs/history/gates/GATE_2_5B_FILE_AND_TEACHING_ARTIFACTS.md"
  },
  {
    name: "Gate 2.5C",
    ...
    document: "docs/history/gates/TEACHER_PRODUCT_STABILIZATION_MATRIX.md"
  },
  {
    name: "Gate 2.7",
    ...
    document: "docs/history/gates/GATE_2_7_ASSIGNMENT_LEARNING_EVIDENCE.md"
  },
  {
    name: "Gate 2.8",
    ...
    document: "docs/history/gates/GATE_2_8_TEACHER_WORKBENCH.md"
  },
  {
    name: "Gate 2.9",
    ...
    document: "docs/history/gates/GATE_2_9_CLASSROOM_REFLECTION_LOOP.md"
  },
  {
    name: "Gate 2.10A",
    ...
    document: "docs/history/gates/GATE_2_10A_IDENTITY_ORGANIZATION_FOUNDATION.md"
  }
];
...
const versionHistory = read("docs/VERSION_HISTORY.md");
